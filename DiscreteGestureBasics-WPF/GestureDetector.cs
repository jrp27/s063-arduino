...
namespace Microsoft.Samples.Kinect.DiscreteGestureBasics
{
    ...
    public class GestureDetector : IDisposable
    {
        ...
        private readonly string gestureDatabase = @"C:\Users\Jeanie\OneDrive\Documents\Senior Year\6.S063\Project\DiscreteGestureBasics-WPF\Database\DeskDetection.gbd";

        /// <summary> Name of the discrete gesture in the database that we want to track </summary>
        private readonly string nappingGestureName = "Napping";
        private readonly string standingGestureName = "Standing";
        private readonly string seatedGestureName = "Seated";
        private readonly string typingGestureName = "Typing";
        private readonly string writingGestureName = "Writing";
        private readonly string usingPhoneGestureName = "UsingPhone";
        ...
        private void Source_TrackingIdLost(object sender, TrackingIdLostEventArgs e)
        {
            ...
            this.GestureResultView.UpdateGestureResult(false, false, false, false, false, false, false);
        }
    }
}
